...
public class SudokuUI extends javax.swing.JFrame
{
    ...
    {//GEN-FIRST:event_newGameActionPerformed
        grid = Sudoku.GRID_9X9;
    ...
    {//GEN-FIRST:event_resetGameActionPerformed
    ...
    {//GEN-FIRST:event_intermediatorActionPerformed
        gameMode = Sudoku.GAME_MODE_MEDIUM;
        int[][] puzzle = sudoku.getNewPuzzle(grid, gameMode);
        createBoard(puzzle);
    ...
    {//GEN-FIRST:event_expartActionPerformed
    ...
    {//GEN-FIRST:event_beginnerActionPerformed
    ...
    {//GEN-FIRST:event_newGame6X6ActionPerformed
    ...
    {//GEN-FIRST:event_resumeActionPerformed
        stopWatch.resume();
        paused = false;
        holder.removeAll();
        holder.add(board);
